<template>
  ...
  <div class="business">
    <el-card>
      <el-form :inline="true" :model="form" ref="form">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="add" ref="addBusiness">+新增企业</el-button>
        </el-form-item>
      </el-form>
    </el-card>
         <!-- el-table
        ...
        <el-table :data ="tableData">
          <el-table-column label ="序号" width="50px">
            <template slot-scope="scope">
             {{pagination.pageSize*(pagination.currentPage-1)+scope.$index+1}}
            </template>
          </el-table-column>
          ...
          <el-table-column label="状态" >
            <template slot-scope="scope">
              <!-- class绑定  :class ={class类名： boolean值  true:使用该class,  flase:不适用该class} -->
   ...
   <addBusiness ref="addBusiness" :mode="modeFater"></addBusiness>
  </div>
</template>

<script>
import {getBusinessData,setBusinessData,delBusinessData} from '@/api/business.js'
...
export default {
  ...
  methods: {
    ...
    reset(){
      // 调用form表单的还原成默认值方法，但前置条件是清空的选项已prop绑定好相应的数据
